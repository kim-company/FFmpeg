...
AVCodec ff_h264_qsv_encoder = {
    ...
    .close          = qsv_enc_close,
    .capabilities   = AV_CODEC_CAP_DELAY, // COMMENTED OUT KIM | AV_CODEC_CAP_HYBRID,
    ...
    .caps_internal  = FF_CODEC_CAP_INIT_CLEANUP // COMMENTED OUT KIM: ,
    // COMMENTED OUT KIM: .wrapper_name   = "qsv",
};
